#ifndef _MY_LABEL_GLOBAL_H
#define _MY_LABEL_GLOBAL_H
...
#		define MYLABEL_SHARED_EXPORT __declspec(dllexport)
#	else
#		define MYLABEL_SHARED_EXPORT __declspec(dllimport)
#	endif
#else
#	define MYLABEL_SHARED_EXPORT
#endif

#endif //_MY_LABEL_GLOBAL_H