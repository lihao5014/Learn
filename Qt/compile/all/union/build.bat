@echo off
echo=
echo "[usage]: build.bat {uic/rcc/moc/cl/g++/clean}"
echo=

set cmd=%1
if "%cmd%" == "clean" (
	del /Q /f *.o *.obj ui_*.h qrc_*.cpp moc_*.cpp main.exe
	exit /b
)
...
if "%cmd%" == "cl" (
	...
	cl /c moc_mainwindow.cpp /Fo"moc_mainwindow.obj"
	cl /c mainwindow.cpp /Fo"mainwindow.obj" /link Qt5Cored.lib Qt5Widgetsd.lib
	echo=
	
	echo --compile main.cpp to main.exe---
	echo=
	cl /Fe"main.exe" main.cpp mainwindow.obj moc_mainwindow.obj qrc_resource.obj /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	del /f main.obj
	echo=
)
...
if "%cmd%" == "g++" (
	...
	g++ -c moc_mainwindow.cpp -o moc_mainwindow.o -I !INCLUDE!
	g++ -c mainwindow.cpp -o mainwindow.o -L !LIB! -lQt5Cored -lQt5Widgetsd -I !INCLUDE!
	echo=

	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp mainwindow.o moc_mainwindow.o qrc_resource.o -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
...
if "%cmd%" == "" (
	...
	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp moc_mainwindow.cpp mainwindow.cpp qrc_resource.cpp -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
