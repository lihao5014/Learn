...
if "%cmd%" == "cl" (
	...
	echo=
	cl /Fe"main.exe" main.cpp mainwindow.obj moc_mainwindow.obj /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	del /f main.obj
	echo=
)
...
if "%cmd%" == "g++" (
	...
	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp mainwindow.o moc_mainwindow.o -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
...
if "%cmd%" == "" (
	...
	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp moc_mainwindow.cpp mainwindow.cpp -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
