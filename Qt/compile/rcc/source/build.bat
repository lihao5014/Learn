...
if "%cmd%" == "cl" (
	...
	echo=
	cl /Fe"main.exe" main.cpp qrc_icon.cpp /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	del /f main.obj
	echo=
)
...
if "%cmd%" == "g++" (
	...
	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp qrc_icon.cpp -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
