...
if "%cmd%" == "cl" (
	...
	cl /c mainwindow.cpp /Fo"mainwindow.obj" /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	echo=
	
	echo --compile main.cpp to main.exe---
	echo=
	cl /Fe"main.exe" main.cpp mainwindow.obj /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	del /f main.obj
	echo=
)
...
if "%cmd%" == "g++" (
	...
	echo ---compile *.cpp to *.obj---
	g++ -c mainwindow.cpp -o mainwindow.o -L !LIB! -lQt5Guid -I !INCLUDE!
	echo=

	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp mainwindow.o -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
