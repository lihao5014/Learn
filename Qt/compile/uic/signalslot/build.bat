...
if "%cmd%" == "cl" (
	...
	echo=
	cl /Fe"main.exe" main.cpp mainwindow.cpp moc_mainwindow.cpp /link Qt5Cored.lib Qt5Widgetsd.lib Qt5Guid.lib
	del /f main.obj mainwindow.obj moc_mainwindow.obj
	echo=
)
...
if "%cmd%" == "g++" (
	...
	echo --compile main.cpp to main.exe---
	echo=
	g++ main.cpp mainwindow.cpp moc_mainwindow.cpp -L !LIB! -lQt5Cored -lQt5Widgetsd -lQt5Guid -o main.exe -I !INCLUDE!
	echo=
)
